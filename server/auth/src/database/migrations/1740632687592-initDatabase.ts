...
export class InitDatabase1740632687592 implements MigrationInterface {
    name = 'InitDatabase1740632687592'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_cbf62122e9f9d90ecad419d49f\` ON \`refresh_token\``);
        await queryRunner.query(`DROP INDEX \`IDX_192c36a5937bf5eeb9de99290b\` ON \`refresh_token\``);
